...
# Beyond PUE: Tackling IT Efficiency

## 1. Source Identity

| 항목 | 내용 |
|---|---|
| 발행기관 | Uptime Institute |
| 저자·발표자 | unknown |
| 원문 유형 | `official_page` |
| 발행일·수정일 | unknown / unknown |
| 수집일 | 2026-06-21 |
| 원문 언어 | `en` |
| 원문 URL | https://uptimeinstitute.com/beyond-pue-tackling-it-efficiency |
| 최종 도달 URL | https://uptimeinstitute.com/beyond-pue-tackling-it-efficiency |
| 수집 범위 | `partial` |
| 라이선스 | `unknown` |

## 2. Evidence Abstract

PUE의 적용 범위와 데이터센터 효율 평가 시 보완 지표가 필요한 이유.

## 3. Atomic Claims

| claim_id | 원문 위치 | 주체 | 주장·사실 | 수치·기간 | 근거 유형 | 확실성 |
|---|---|---|---|---|---|---|
| `src_uptime_institute_pue_c01` | Source Notes / 원문 재확인 필요 | Uptime Institute | PUE의 적용 범위와 데이터센터 효율 평가 시 보완 지표가 필요한 이유. | - | measured_or_reported | medium |
...
|---|---|---|---|
| `pue` | PUE | 이 Source가 관련 근거로 사용되는 개념 | [[concepts/pue|PUE]] |
...
| 평가 항목 | 판단 | 이유 |
|---|---|---|
| 출처 직접성 | `high` | Uptime Institute의 자료 유형과 발행 주체를 기준으로 평가 |
...
|---|---|---|
| [[concepts/pue|PUE]] | `src_uptime_institute_pue_c01` | 개념 정의·맥락 근거 |

## 11. Update Hooks

- **변경 감지 기준:** 원문 수정일, 핵심 수치, 제품 버전, 파트너, 투자·생산·구축 목표 변경
- **영향받는 Entity:** [[concepts/pue|PUE]]

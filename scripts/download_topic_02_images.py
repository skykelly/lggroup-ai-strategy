...
Usage:
  python scripts/download_topic_02_images.py
"""
...
MANIFEST = {
  "topic_id": "topic_how_competitive_is_exaone_globally",
  ...
  "images": [
    {
      ...
      "filename": "topic_02_lgai_exaone_journey.png",
      "caption": "EXAONE은 2021년 1.0부터 2026년 4.5까지 멀티모달·추론·산업 적용 방향으로 진화해왔다.",
      "status": "confirmed"
    },
    {
      ...
      "filename": "topic_02_lgai_exaone_logo.png",
      "caption": "EXAONE은 LG AI Research가 개발한 LLM/LMM 계열 모델 브랜드다.",
      "status": "confirmed"
    },
    {
      ...
      "filename": "topic_02_lgai_exaone45_performance.png",
      "caption": "EXAONE 4.5는 문서 이해와 한국어 맥락 이해에서 강점을 강조한다.",
      "status": "confirmed"
    },
    {
      ...
      "filename": "topic_02_exaone45_github_symbol.png",
      "caption": "EXAONE 4.5 GitHub repository는 공개 모델, 기술보고서, 사용 방법을 함께 제공한다.",
      "status": "confirmed"
    }
  ]
}
...
def download_file(item: dict, out_dir: Path, timeout: int = 30) -> dict:
    ...
    if url == "IMAGE_URL_NEEDED":
        return {
            ...
            "used_by": ["topics/02_how_competitive_is_exaone_globally.md"],
...
def main() -> None:
    ...
    manifest_path = out_dir / "topic_02_image_download_manifest.json"
    inventory_path = data_dir / "image_inventory.topic_02.json"

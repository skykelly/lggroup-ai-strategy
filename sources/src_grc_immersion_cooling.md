---
id: src_grc_immersion_cooling
type: source
title: GRC The Immersion Cooling Authority®
publisher: GRC
published: unknown
...
- grc
authors: []
updated: Sun, 21 Jun 2026 08:40:10 GMT
...
archive_url: null
local_raw_path: null
content_hash: 0cf54846bf005448282c7b30358d937ddae91bbb502ab7322ebbda976a43e88d
license: unknown
reliability_grade: B
---
...
| 저자·발표자 | unknown |
| 원문 유형 | `official_page` |
| 발행일·수정일 | unknown / Sun, 21 Jun 2026 08:40:10 GMT |
| 수집일 | 2026-06-21 |
| 원문 언어 | `en` |
| 원문 URL | https://www.grcooling.com/ |
| 최종 도달 URL | https://www.grcooling.com/ |
| 수집 범위 | `partial` |
| 라이선스 | `unknown` |

## 2. Evidence Abstract

데이터센터 액침냉각 기술과 운영 역량 확인. LG와의 직접 협력은 공개 근거 미확인.

## 3. Atomic Claims

| claim_id | 원문 위치 | 주체 | 주장·사실 | 수치·기간 | 근거 유형 | 확실성 |
|---|---|---|---|---|---|---|
| `src_grc_immersion_cooling_c01` | Source Notes / 원문 재확인 필요 | GRC | 데이터센터 액침냉각 기술과 운영 역량 확인. | - | measured_or_reported | medium |
| `src_grc_immersion_cooling_c02` | Source Notes / 원문 재확인 필요 | GRC | LG와의 직접 협력은 공개 근거 미확인. | - | statement | high |
...
| 평가 항목 | 판단 | 이유 |
|---|---|---|
| 출처 직접성 | `high` | GRC의 자료 유형과 발행 주체를 기준으로 평가 |
...
|---|---|---|
| 연결 Entity 없음 | - | Source metadata 보강 필요 |

## 11. Update Hooks

- **변경 감지 기준:** 원문 수정일, 핵심 수치, 제품 버전, 파트너, 투자·생산·구축 목표 변경
- **영향받는 Entity:** 연결 Entity 없음
...
- **Content Hash:** `0cf54846bf005448282c7b30358d937ddae91bbb502ab7322ebbda976a43e88d`
- **감지된 heading 수:** 20

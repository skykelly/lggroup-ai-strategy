...
archive_url: null
local_raw_path: null
content_hash: 66da420ac5a95cb24a81fa89431003555e367524b11699a33e56c55c7c5791a0
license: unknown
reliability_grade: B
---
...
| 수집일 | 2026-06-21 |
| 원문 언어 | `en` |
| 원문 URL | https://www.skenmove.com/ |
| 최종 도달 URL | https://www.skenmove.com/ |
| 수집 범위 | `partial` |
| 라이선스 | `unknown` |

## 2. Evidence Abstract

열관리·윤활 기반 사업 역량 확인. LG AIDC 직접 협력은 공개 근거 미확인.

## 3. Atomic Claims

| claim_id | 원문 위치 | 주체 | 주장·사실 | 수치·기간 | 근거 유형 | 확실성 |
|---|---|---|---|---|---|---|
| `src_sk_enmove_official_c01` | Source Notes / 원문 재확인 필요 | SK Enmove | 열관리·윤활 기반 사업 역량 확인. | - | statement | high |
| `src_sk_enmove_official_c02` | Source Notes / 원문 재확인 필요 | SK Enmove | LG AIDC 직접 협력은 공개 근거 미확인. | - | statement | high |
...
| 평가 항목 | 판단 | 이유 |
|---|---|---|
| 출처 직접성 | `high` | SK Enmove의 자료 유형과 발행 주체를 기준으로 평가 |
...
- **Content Hash:** `66da420ac5a95cb24a81fa89431003555e367524b11699a33e56c55c7c5791a0`
- **감지된 heading 수:** 6

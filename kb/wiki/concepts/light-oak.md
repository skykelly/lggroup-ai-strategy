...
- role: hero_candidate
  source: Unsplash
  url: https://unsplash.com/s/photos/light+oak+furniture+interior+white+beige+apartment
  search_query: light oak furniture interior white beige apartment
  alt_text_ko: 라이트 오크 결·색조와 화이트·베이지 조합
- role: alternative_candidate
  source: Pexels
  url: https://www.pexels.com/search/light+oak+furniture+interior+white+beige+apartment/
  search_query: light oak furniture interior white beige apartment
  alt_text_ko: 라이트 오크 결·색조와 화이트·베이지 조합
- role: reference_search
  source: Wikimedia Commons
  url: https://commons.wikimedia.org/w/index.php?search=light+oak+furniture+interior+white+beige+apartment&title=Special:MediaSearch&type=image
  search_query: light oak furniture interior white beige apartment
  alt_text_ko: 라이트 오크 결·색조와 화이트·베이지 조합
...
- **이미지 설명/대체 텍스트:** 라이트 오크 결·색조와 화이트·베이지 조합
- **권장 구도:** 4:3 material in room
- **검색 문구:** `light oak furniture interior white beige apartment`

### 이미지 후보 링크

| 우선순위 | 출처 | 링크 | 활용 |
|---|---|---|---|
| 1 | Unsplash | [대표 이미지 후보 검색](https://unsplash.com/s/photos/light+oak+furniture+interior+white+beige+apartment) | Hero 이미지 및 공간 전경 후보 |
| 2 | Pexels | [대체 이미지 후보 검색](https://www.pexels.com/search/light+oak+furniture+interior+white+beige+apartment/) | 공간·제품 사용 장면 후보 |
| 3 | Wikimedia Commons | [라이선스 확인이 쉬운 후보 검색](https://commons.wikimedia.org/w/index.php?search=light+oak+furniture+interior+white+beige+apartment&title=Special:MediaSearch&type=image) | 출처·라이선스가 명확한 이미지 후보 |
| 보조 | Bing Images | [추가 레퍼런스 검색](https://www.bing.com/images/search?q=light+oak+furniture+interior+white+beige+apartment) | 시각 방향 탐색용이며 원출처를 다시 확인해야 함 |
...
|---:|---|---|---|---|
| 1 | 오늘의집 2026 인테리어 디자인 트렌드 | [원문 이미지/사례 보기](https://ohou.se/advices/12278) | 2026 스타일·소재·공간 대표 사례 | `reference_url` |

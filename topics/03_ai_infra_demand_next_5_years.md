...
<figure>
  <img src="assets/images/img_lguplus_paju_pulse_01.png" alt="AI Infra 수요는 GPU 서버만이 아니라 대규모 전력·입지·냉각을 요구하는 물리 인프라 수요로 나타난다." style="max-width:100%; border-radius:8px;" />
  <figcaption><small>AI Infra 수요는 GPU 서버만이 아니라 대규모 전력·입지·냉각을 요구하는 물리 인프라 수요로 나타난다. 출처: <a href="https://pulse.mk.co.kr/news/english/12068307">Pulse by Maeil Business News Korea</a></small></figcaption>
</figure>
...
<figure>
  <img src="assets/images/topic_01_lguplus_ace_on_trust.png" alt="LG U+는 AIDC 전략을 Agility, Capacity, Efficiency, Trust로 설명한다." style="max-width:100%; border-radius:8px;" />
...
<figure>
  <img src="assets/images/topic_01_nvidia_800v_architecture.png" alt="차세대 AI Factory에서는 전력 분배 구조와 에너지 효율이 경쟁 요소가 된다." style="max-width:100%; border-radius:8px;" />

...
archive_url: null
local_raw_path: null
content_hash: 406749d797c27a7efda067af36440ee29d82709d0a049bbaf248d9153a27211a
license: unknown
reliability_grade: B
---

# LS ELECTRIC Official
...
| 수집일 | 2026-06-21 |
| 원문 언어 | `en` |
| 원문 URL | https://www.ls-electric.com/ |
| 최종 도달 URL | https://www.ls-electric.com/ |
| 수집 범위 | `partial` |
| 라이선스 | `unknown` |

## 2. Evidence Abstract

전력기기·배전·에너지 관리 역량 확인. LG AIDC 직접 협력은 공개 근거 미확인.

## 3. Atomic Claims

| claim_id | 원문 위치 | 주체 | 주장·사실 | 수치·기간 | 근거 유형 | 확실성 |
|---|---|---|---|---|---|---|
| `src_ls_electric_official_c01` | Source Notes / 원문 재확인 필요 | LS ELECTRIC | 전력기기·배전·에너지 관리 역량 확인. | - | statement | high |
| `src_ls_electric_official_c02` | Source Notes / 원문 재확인 필요 | LS ELECTRIC | LG AIDC 직접 협력은 공개 근거 미확인. | - | statement | high |
...
| 평가 항목 | 판단 | 이유 |
|---|---|---|
| 출처 직접성 | `high` | LS ELECTRIC의 자료 유형과 발행 주체를 기준으로 평가 |
...
- **Content Hash:** `406749d797c27a7efda067af36440ee29d82709d0a049bbaf248d9153a27211a`
- **감지된 heading 수:** 0

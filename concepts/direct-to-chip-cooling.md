---
id: concept_direct_to_chip_cooling
type: concept
...
| 관련 테마 | 연결 이유 |
|---|---|
| [[docs/01_ai_data_center_infra]] | **Direct-to-Chip Cooling**: GPU/CPU 칩 직접 냉각 방식. AI 연산 용량보다 전력·냉각·가동률을 함께 최적화하는 AIDC 사업성의 설계 변수다. |

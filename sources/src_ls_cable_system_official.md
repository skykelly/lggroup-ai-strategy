---
id: src_ls_cable_system_official
type: source
...
archive_url: null
local_raw_path: null
content_hash: ba3c8948aca2c4bf32e58c302b1a56ea4e8f38e4179cd0c15de6f595496932a2
license: unknown
reliability_grade: B
---

# LS Cable & System Official

## 1. Source Identity

| 항목 | 내용 |
|---|---|
| 발행기관 | LS Cable & System |
| 저자·발표자 | unknown |
| 원문 유형 | `official_page` |
| 발행일·수정일 | unknown / unknown |
| 수집일 | 2026-06-21 |
| 원문 언어 | `en` |
| 원문 URL | https://www.lscns.com/ |
| 최종 도달 URL | https://www.lscns.com/ |
| 수집 범위 | `partial` |
| 라이선스 | `unknown` |

## 2. Evidence Abstract

전력·통신 케이블과 인프라 구축 역량 확인. LG AIDC 직접 협력은 공개 근거 미확인.

## 3. Atomic Claims

| claim_id | 원문 위치 | 주체 | 주장·사실 | 수치·기간 | 근거 유형 | 확실성 |
|---|---|---|---|---|---|---|
| `src_ls_cable_system_official_c01` | Source Notes / 원문 재확인 필요 | LS Cable & System | 전력·통신 케이블과 인프라 구축 역량 확인. | - | statement | high |
| `src_ls_cable_system_official_c02` | Source Notes / 원문 재확인 필요 | LS Cable & System | LG AIDC 직접 협력은 공개 근거 미확인. | - | statement | high |
...
| 평가 항목 | 판단 | 이유 |
|---|---|---|
| 출처 직접성 | `high` | LS Cable & System의 자료 유형과 발행 주체를 기준으로 평가 |
...
- **Content Hash:** `ba3c8948aca2c4bf32e58c302b1a56ea4e8f38e4179cd0c15de6f595496932a2`
- **감지된 heading 수:** 0

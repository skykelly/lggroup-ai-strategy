...
topics/03_ai_infra_demand_next_5_years.md
...
Usage:
  python scripts/download_topic_03_images.py
"""
...
MANIFEST = {
  "topic_id": "topic_ai_infra_demand_next_5_years",
  ...
  "images": [
    {
      ...
      "filename": "topic_03_iea_datacenter_electricity_chart.png",
      "caption": "IEA의 데이터센터 전력 소비 전망 차트. 원문은 차트 다운로드를 제공하지만 직접 이미지 URL은 동적 렌더링으로 별도 확보 필요.",
    ...
    },
    {
      ...
      "filename": "topic_03_lguplus_paju_aidc_site.png",
      "caption": "AI Infra 수요는 GPU 서버만이 아니라 대규모 전력·입지·냉각을 요구하는 물리 인프라 수요로 나타난다.",
      "status": "confirmed"
    },
    {
      ...
      "filename": "topic_03_lguplus_ace_on_trust.png",
      "caption": "LG U+는 AIDC 전략을 Agility, Capacity, Efficiency, Trust로 설명한다.",
      "status": "confirmed"
    },
    {
      ...
      "filename": "topic_03_lge_dcw_cdu_press.png",
      "caption": "전력 밀도가 높아질수록 냉각은 AI Infra의 핵심 병목이 된다.",
      "status": "confirmed"
    },
    {
      ...
      "filename": "topic_03_nvidia_800v_architecture.png",
      "caption": "차세대 AI Factory에서는 전력 분배 구조와 에너지 효율이 경쟁 요소가 된다.",
      "status": "confirmed"
    }
  ]
}
...
def download_file(item: dict, out_dir: Path, timeout: int = 30) -> dict:
    ...
    if url == "IMAGE_URL_NEEDED":
        return {
            ...
            "used_by": ["topics/03_ai_infra_demand_next_5_years.md"],
...
def main() -> None:
    ...
    manifest_path = out_dir / "topic_03_image_download_manifest.json"
    inventory_path = data_dir / "image_inventory.topic_03.json"

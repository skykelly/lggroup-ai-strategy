---
id: concept_chemical_agentic_ai
type: concept
title: Chemical Agentic AI
aliases: []
...
| 관련 테마 | 연결 이유 |
|---|---|
| [[docs/05_ai_for_science_bio_materials_battery]] | **Chemical Agentic AI**: 화학 R&D Agentic AI. 후보 탐색과 실험 검증 사이의 반복 시간을 줄여 R&D throughput을 높이는 수단이다. |

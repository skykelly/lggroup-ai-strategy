...
| 항목 | 내용 |
|---|---|
| 발행기관 | Vanderbilt University Medical Center |
| 저자·발표자 | unknown |
| 원문 유형 | `official_page` |
| 발행일·수정일 | unknown / unknown |
| 수집일 | 2026-06-21 |
| 원문 언어 | `en` |
| 원문 URL | https://www.vumc.org/research/ |
| 최종 도달 URL | https://www.vumc.org/research/ |
| 수집 범위 | `partial` |
| 라이선스 | `unknown` |

## 2. Evidence Abstract

의료·임상 연구 및 validation 역량 확인. LG AI Research와의 직접 협력은 공개 근거 미확인.

## 3. Atomic Claims

| claim_id | 원문 위치 | 주체 | 주장·사실 | 수치·기간 | 근거 유형 | 확실성 |
|---|---|---|---|---|---|---|
| `src_vumc_research_c01` | Source Notes / 원문 재확인 필요 | Vanderbilt University Medical Center | 의료·임상 연구 및 validation 역량 확인. | - | statement | high |
| `src_vumc_research_c02` | Source Notes / 원문 재확인 필요 | LG AI Research | LG AI Research와의 직접 협력은 공개 근거 미확인. | - | statement | high |
...
- 원문 자동 수집 실패: HTTP 404: Not Found.

## 9. Reliability Assessment

| 평가 항목 | 판단 | 이유 |
|---|---|---|
| 출처 직접성 | `high` | Vanderbilt University Medical Center의 자료 유형과 발행 주체를 기준으로 평가 |
...
- **원문 수집 상태:** `failed`
- **HTTP / 오류:** `404` / HTTP 404: Not Found

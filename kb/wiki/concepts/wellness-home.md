...
- role: hero_candidate
  source: Unsplash
  url: https://unsplash.com/s/photos/wellness+home+interior+natural+light+calm+air+quality+bedroom
...
- role: alternative_candidate
  source: Pexels
  url: https://www.pexels.com/search/wellness+home+interior+natural+light+calm+air+quality+bedroom/
  search_query: wellness home interior natural light calm air quality bedroom
  alt_text_ko: 자연광·식물·편안한 소재가 있는 회복형 집
- role: reference_search
  source: Wikimedia Commons
  url: https://commons.wikimedia.org/w/index.php?search=wellness+home+interior+natural+light+calm+air+quality+bedroom&title=Special:MediaSearch&type=image
  search_query: wellness home interior natural light calm air quality bedroom
  alt_text_ko: 자연광·식물·편안한 소재가 있는 회복형 집
...
- **이미지 설명/대체 텍스트:** 자연광·식물·편안한 소재가 있는 회복형 집
- **권장 구도:** 16:9 wellness scene
- **검색 문구:** `wellness home interior natural light calm air quality bedroom`

### 이미지 후보 링크

| 우선순위 | 출처 | 링크 | 활용 |
|---|---|---|---|
| 1 | Unsplash | [대표 이미지 후보 검색](https://unsplash.com/s/photos/wellness+home+interior+natural+light+calm+air+quality+bedroom) | Hero 이미지 및 공간 전경 후보 |
| 2 | Pexels | [대체 이미지 후보 검색](https://www.pexels.com/search/wellness+home+interior+natural+light+calm+air+quality+bedroom/) | 공간·제품 사용 장면 후보 |
| 3 | Wikimedia Commons | [라이선스 확인이 쉬운 후보 검색](https://commons.wikimedia.org/w/index.php?search=wellness+home+interior+natural+light+calm+air+quality+bedroom&title=Special:MediaSearch&type=image) | 출처·라이선스가 명확한 이미지 후보 |
| 보조 | Bing Images | [추가 레퍼런스 검색](https://www.bing.com/images/search?q=wellness+home+interior+natural+light+calm+air+quality+bedroom) | 시각 방향 탐색용이며 원출처를 다시 확인해야 함 |
